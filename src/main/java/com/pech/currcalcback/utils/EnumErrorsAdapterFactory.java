...
public class EnumErrorsAdapterFactory implements TypeAdapterFactory
{
    @Override
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> type)
    {
        ...
        if (rawType.isEnum())
        {
            return new EnumErrorsAdapter<T>();
        }
        return null;
    }

    public class EnumErrorsAdapter<T> extends TypeAdapter<T>
    {
        @Override
